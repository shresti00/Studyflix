  ...
  return (
    <div className="playlists-body">
      ...
      <div className="container" style={{ paddingBottom: '60px' }}>
        <div className="info" style={{ marginBottom: '40px' }}>
          <p className="desc" style={{ fontSize: '1.1rem', opacity: 0.9 }}>
            Explore the 3 core academic subjects. Filter by 7 distinct modules per subject to focus your study flow natively. Check videos off sequentially!
          </p>
        </div>
        ...
        <PlaylistSection 
          ...
          query="Data Structure and Algorithms full course" 
          fallbackData={fallbackDSA} 
        />
        
        <PlaylistSection 
          subjectKey="MPMC"
          title="Microprocessors & Microcontrollers" 
          query="Microprocessors 8086 microcontrollers tutorial" 
          fallbackData={fallbackDSA} 
        />
        ...
        <PlaylistSection 
          ...
          query="Theory of Computation automota turing machines" 
          fallbackData={fallbackDSA} 
        />
      </div>
    </div>
